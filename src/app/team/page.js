                            ...
                            {team.members.map((member, mIdx) => (
                                <div
                                    ...
                                    className="team-card group bg-white rounded-2xl p-8 shadow-[0_10px_30px_rgba(0,0,0,0.05)] 
                                               ...
                                               hover:-translate-y-2 active:scale-95 border border-gray-100 relative overflow-hidden"
                                >
                                    {/* Image */}
                                    ...
                                    <div className="text-center relative z-10">
                                        ...
                                        {/* DECORATIVE LINE: Wide on mobile, small on desktop (grows on hover) */}
                                        <div className="h-1 bg-[#6082b6]/20 mx-auto rounded-full mb-6 
                                                        w-24 lg:w-12 lg:group-hover:w-24 lg:group-hover:bg-[#6082b6] 
                                                        transition-all duration-300"></div>

                                        {/* SOCIAL ICON: Visible on mobile, Hidden on desktop (shows on hover) */}
