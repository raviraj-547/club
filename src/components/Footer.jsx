            ...
            <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-12 gap-10">
                ...
                <div className="md:col-span-3">
                    ...
                    <ul className="space-y-3">
                        ...
                        <li>
                            <Link href="/team" className="hover:text-cyan-400 transition-colors flex items-center gap-2 group">
                                <span className="text-slate-600 group-hover:text-cyan-400">./</span>team
                            </Link>
                        </li>
                        <li>
                            <Link href="/events" className="hover:text-cyan-400 transition-colors flex items-center gap-2 group">
